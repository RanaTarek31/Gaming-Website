export class Ui {
  displayDataGame(data) {
    if (!data || !Array.isArray(data)) {
      console.error("Invalid data provided to displayDataGame.");
      return;
    }
  ...
  displayDetails(data) {
    if (!data) {
      console.error("Invalid data provided to displayDetails.");
      return;
    }

    const content = `
      <div class="col-md-4">
        <img src="${data.thumbnail}" class="w-100" alt="${data.title} Image Details" />
      </div>
      <div class="col-md-8">
